...
class CustomFizUserAdmin(admin.ModelAdmin):
    list_display = ('email', 'shop_name', 'full_name', 'phone', 'promo_code', 'terms_of_service', 'is_active')
    list_filter = ('is_active', 'promo_code', 'terms_of_service')
    search_fields = ('email', 'shop_name', 'full_name', 'phone')
class CustomUrUserAdmin(admin.ModelAdmin):
    list_display = ('email', 'form', 'shop_name', 'phone', 'full_name', 'city', 'organization_name', 'legal_address', 'inn', 'kpp', 'bank', 'bik', 'account_number', 'correspondent_account', 'terms_of_service', 'is_active')
    search_fields = ('email', 'shop_name', 'full_name', 'phone', 'organization_name')
